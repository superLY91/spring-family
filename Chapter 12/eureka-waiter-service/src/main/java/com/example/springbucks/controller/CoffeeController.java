...
import com.example.springbucks.controller.exception.FormValidationException;
import com.example.springbucks.controller.request.NewCoffeeRequest;
...
//    @ResponseBody
//    @ResponseStatus(HttpStatus.CREATED)
//    public Coffee addCoffeeWithoutBindResult(@Valid NewCoffeeRequest newCoffee) {
//        return coffeeService.saveCoffee(newCoffee.getName(), newCoffee.getPrice());
//    }
